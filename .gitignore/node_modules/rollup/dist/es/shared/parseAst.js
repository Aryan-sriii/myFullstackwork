...
*/
import { parse, parseAsync } from 'rollup/dist/native.js';
...
/** @typedef {import('rollup/dist/es/shared/types.js').Location} Location */

/**
 * @param {import('rollup/dist/es/shared/types.js').Range} range
 * @param {number} index
 */
...
/**
 * @param {string} source
 * @param {import('rollup/dist/es/shared/types.js').Options} [options]
 */
function getLocator(source, options = {}) {
	...
	const ranges = source.split('\n').map((line, i) => {
		...
		/** @type {import('rollup/dist/es/shared/types.js').Range} */
